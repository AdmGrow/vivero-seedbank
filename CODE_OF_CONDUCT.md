...
Instancias de comportamiento abusivo, acosador o inaceptable de otro modo podrán ser reportadas a los administradores de la comunidad responsables del cumplimiento a través de alguno de estos canales, sin necesidad de exponer datos personales:

* La herramienta de reporte privado de GitHub (opción **"Report content"** en el comentario, issue o discusión, o **"Report abuse"** en el perfil de la persona), que no se hace público y llega a GitHub (y a los administradores del repositorio cuando el reporte de contenido está activado).
* Un mensaje a los administradores del proyecto a través del [foro de Discussions](https://github.com/AdmGrow/vivero-seedbank/discussions), indicando solo que querés hacer un reporte de conducta, sin incluir detalles sensibles en público. Los administradores coordinarán un canal privado para continuar.

Los problemas de seguridad del software se reportan aparte, según [SECURITY.md](SECURITY.md).
